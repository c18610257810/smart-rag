...
const Chat = forwardRef<ChatRef, ChatProps>((props, ref) => {
  ...
  return (
    <div className="smart-rag-chat-container">
      <div className="smart-rag-chat-header">
        <h1 className="smart-rag-chat-header-title">Chat</h1>
        <div className="smart-rag-chat-header-buttons">
          <button
      ...
      <div className="smart-rag-chat-messages" ref={chatMessagesRef}>
        ...
        {showContinueResponseButton && (
          <div className="smart-rag-continue-response-button-container">
            <button
              className="smart-rag-continue-response-button"
        ...
        {submitChatMutation.isPending && (
          <button onClick={abortActiveStreams} className="smart-rag-stop-gen-btn">
            <CircleStop size={16} />

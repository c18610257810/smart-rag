...
export default function QueryProgress({
  ...
  switch (state.type) {
    ...
    case 'reading-mentionables':
      return (
        <div className="smart-rag-query-progress">
          <p>
    ...
    case 'indexing':
      return (
        <div className="smart-rag-query-progress">
          ...
          <p className="smart-rag-query-progress-detail">{`${state.indexProgress.completedChunks}/${state.indexProgress.totalChunks} chunks indexed`}</p>
          {state.indexProgress.waitingForRateLimit && (
            <p className="smart-rag-query-progress-detail">

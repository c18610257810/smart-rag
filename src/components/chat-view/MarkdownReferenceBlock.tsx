...
export default function MarkdownReferenceBlock({
  ...
  return (
    blockContent && (
      <div className={clsx('smart-rag-code-block', filename && 'has-filename')}>
        <div className="smart-rag-code-block-header">
          {filename && (
            <div
              className="smart-rag-code-block-header-filename"
              onClick={handleOpenFile}
            >
              {filename}
            </div>
          )}
          <div className="smart-rag-code-block-header-button-container">
            <button
              className="clickable-icon smart-rag-code-block-header-button"
              onClick={() => {
        ...
        {isPreviewMode ? (
          <div className="smart-rag-code-block-obsidian-markdown">

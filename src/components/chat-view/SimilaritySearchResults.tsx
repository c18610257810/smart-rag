...
function SimiliartySearchItem({
  ...
  return (
    <div onClick={handleClick} className="smart-rag-similarity-search-item">
      <div className="smart-rag-similarity-search-item__similarity">
        {chunk.similarity.toFixed(3)}
      </div>
      <div className="smart-rag-similarity-search-item__path">
        {path.basename(chunk.path)}
      </div>
      <div className="smart-rag-similarity-search-item__line-numbers">
...
export default function SimilaritySearchResults({
  ...
  return (
    <div className="smart-rag-similarity-search-results">
      <div
        onClick={() => {
          setIsOpen(!isOpen)
        }}
        className="smart-rag-similarity-search-results__trigger"
      >

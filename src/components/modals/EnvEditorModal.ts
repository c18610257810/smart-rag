...
export class EnvEditorModal extends Modal {
  ...
  onOpen() {
    ...
    const desc = contentEl.createDiv({ cls: 'smart-rag-modal-desc' });
    ...
    const textAreaContainer = contentEl.createDiv({ cls: 'smart-rag-env-container' });
    
    const textArea = textAreaContainer.createEl('textarea', {
      cls: 'smart-rag-env-textarea-full',
      text: this.content
    });
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'smart-rag-modal-actions' });

...
export function McpSection({ app, plugin }: McpSectionProps) {
  ...
  return (
    <div className="smart-rag-settings-section">
      <div className="smart-rag-settings-header">MCP (Model Context Pool)</div>

      <div className="smart-rag-settings-desc smart-rag-settings-callout">
      ...
      {mcpManager?.disabled ? (
        <div className="smart-rag-settings-sub-header-container">
          <div className="smart-rag-settings-sub-header">
        ...
        <>
          <div className="smart-rag-settings-sub-header-container">
            <div className="smart-rag-settings-sub-header">MCP Servers</div>
            <ObsidianButton
              text="Add MCP Server"
          ...
          <div className="smart-rag-mcp-servers-container">
            <div className="smart-rag-mcp-servers-header">
              <div>Server</div>
              <div>Status</div>
              <div>Enabled</div>
              <div>Actions</div>
            ...
            {mcpServers.length > 0 ? (
              ...
              <div className="smart-rag-mcp-servers-empty">
...
function McpServerComponent({
  ...
  return (
    <div className="smart-rag-mcp-server">
      <div className="smart-rag-mcp-server-row">
        <div className="smart-rag-mcp-server-name">{server.name}</div>
        <div className="smart-rag-mcp-server-status">
          <McpServerStatusBadge status={server.status} />
        </div>
        <div className="smart-rag-mcp-server-toggle">
          <ObsidianToggle
            value={server.config.enabled}
            onChange={handleToggleEnabled}
          />
        </div>
        <div className="smart-rag-mcp-server-actions">
          <button
            onClick={handleEdit}
...
function ExpandedServerInfo({ server }: { server: McpServerState }) {
  ...
  return (
    <div className="smart-rag-server-expanded-info">
      {server.status === McpServerStatus.Connected && (
        <div>
          <div className="smart-rag-server-expanded-info-header">Tools</div>
          <div className="smart-rag-server-tools-container">
      ...
      {server.status === McpServerStatus.Error && (
        <div>
          <div className="smart-rag-server-expanded-info-header">Error</div>
          <div className="smart-rag-server-error-message">
...
function McpServerStatusBadge({ status }: { status: McpServerStatus }) {
  const statusConfig = {
    [McpServerStatus.Connected]: {
      icon: <Check size={16} />,
      label: 'Connected',
      statusClass: 'smart-rag-mcp-server-status-badge--connected',
    },
    [McpServerStatus.Connecting]: {
      icon: <Loader2 size={16} className="spinner" />,
      label: 'Connecting...',
      statusClass: 'smart-rag-mcp-server-status-badge--connecting',
    },
    [McpServerStatus.Error]: {
      icon: <X size={16} />,
      label: 'Error',
      statusClass: 'smart-rag-mcp-server-status-badge--error',
    },
    [McpServerStatus.Disconnected]: {
      icon: <CircleMinus size={16} />,
      label: 'Disconnected',
      statusClass: 'smart-rag-mcp-server-status-badge--disconnected',
    },
  }
  ...
  return (
    <div className={`smart-rag-mcp-server-status-badge ${statusClass}`}>
      {icon}
      <div className="smart-rag-mcp-server-status-badge-label">{label}</div>
    </div>
  )
}
...
function McpToolComponent({
  ...
  return (
    <div className="smart-rag-mcp-tool">
      <div className="smart-rag-mcp-tool-info">
        <div className="smart-rag-mcp-tool-name">{tool.name}</div>
        <div className="smart-rag-mcp-tool-description">{tool.description}</div>
      </div>
      <div className="smart-rag-mcp-tool-toggle">
        <span className="smart-rag-mcp-tool-toggle-label">Enabled</span>
        <ObsidianToggle
          value={!disabled}
      ...
      <div className="smart-rag-mcp-tool-toggle">
        <span className="smart-rag-mcp-tool-toggle-label">Auto-execute</span>
        <ObsidianToggle

...
export const NeuralSection = ({ plugin }: { plugin: NeuralComposerPlugin }) => {
  ...
  useEffect(() => {
    ...
    if (useCustomOntology) {
        const warningDiv = container.createDiv({ cls: 'smart-rag-setting-warning' });
        ...
        const textAreaContainer = container.createDiv({ cls: 'smart-rag-textarea-container' });
        typesTextArea = textAreaContainer.createEl('textarea', { cls: 'smart-rag-setting-textarea' });
    ...
    summary.addClass('smart-rag-cursor-pointer');
    
    const advancedContainer = details.createDiv({ cls: 'smart-rag-advanced-container' });
    ...
    new Setting(advancedContainer)
        .setClass('smart-rag-env-setting')
        .addTextArea(text => {
            text
            ...
            text.inputEl.addClass('smart-rag-env-textarea');
        });
...
`;
    ...
    new Setting(container)
      ...
      .setClass('smart-rag-restart-setting') 
      .addButton((button) =>
        button

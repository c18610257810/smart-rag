...
export function ChatModelsSubSection({
  ...
  return (
    <div>
      <div className="smart-rag-settings-sub-header">Chat models</div>
      <div className="smart-rag-settings-desc">Models used for chat and apply</div>

      <div className="smart-rag-settings-table-container">
        <table className="smart-rag-settings-table">
          <colgroup>
            <col />
            <col />
            <col />
            <col className="smart-rag-col-enable" />
            <col className="smart-rag-col-actions" />
          </colgroup>
          <thead>
            <tr>
              <th>ID</th>
          ...
          <tbody>
            {settings.chatModels.map((chatModel) => (
              <tr key={chatModel.id}>
                ...
                <td>
                  <div className="smart-rag-settings-actions">

...
export function TemplateSection({ app }: TemplateSectionProps) {
  ...
  return (
    <div className="smart-rag-settings-section">
      <div className="smart-rag-settings-header">Prompt templates</div>
      ...
      <div className="smart-rag-settings-sub-header-container">
        <div className="smart-rag-settings-sub-header">Saved templates</div>
        <ObsidianButton text="Add prompt template" onClick={handleCreate} />
      </div>

      <div className="smart-rag-templates-container">
        <div className="smart-rag-templates-header">
          <div>Name</div>
          <div>Actions</div>
        </div>
        {isLoading ? (
          <div className="smart-rag-templates-empty">Loading templates...</div>
          ...
          <div className="smart-rag-templates-empty">No templates found</div>
        )}
      </div>
    </div>
  )
...
function TemplateItem({
  ...
  return (
    <div className="smart-rag-template">
      <div className="smart-rag-template-row">
        <div className="smart-rag-template-name">{template.name}</div>
        <div className="smart-rag-template-actions">
          <button

...
export class EmbeddingDbManageModal extends ReactModal<EmbeddingDbManagerModalComponentWrapperProps> {
  constructor(app: App, plugin: NeuralComposerPlugin) {
    ...
    this.modalEl.addClass('smart-rag-embedding-db-modal')
  }
}
...
function EmbeddingDbManageModalComponent() {
  ...
  return (
    <div className="smart-rag-settings-embedding-db-manage-root">
      <div className="smart-rag-settings-embedding-db-manage-header">
        <button
        ...
        <span className="smart-rag-settings-embedding-db-manage-last-updated">
          Last updated: {dayjs(dataUpdatedAt).format('YYYY-MM-DD HH:mm:ss')}
        </span>
      </div>
      <table className="smart-rag-settings-embedding-db-manage-table">
        <thead>
          <tr>
            <th>Model</th>
          ...
          {stats.map((stat) => (
            <tr key={stat.model}>
              ...
              {indexProgressMap.get(stat.model) ? (
                <td className="smart-rag-settings-embedding-db-manage-actions-loading">
                ...
                <td className="smart-rag-settings-embedding-db-manage-actions">
                  <button
                    className="clickable-icon"

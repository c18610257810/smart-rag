...
function BadgeBase({
  ...
  return (
    <div
      className={`smart-rag-chat-user-input-file-badge ${isFocused ? 'smart-rag-chat-user-input-file-badge-focused' : ''}`}
      onClick={onClick}
    >
      {children}
      <div
        className="smart-rag-chat-user-input-file-badge-delete"
        onClick={(evt) => {
          evt.stopPropagation()
          onDelete()
        }}
...
function CurrentFileBadge({
  ...
  return mentionable.file ? (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      ...
      <div
        className={clsx(
          'smart-rag-chat-user-input-file-badge-name-suffix',
          !settings.chatOptions.includeCurrentFileContent &&
            'smart-rag-excluded-content',
        )}
      >
...
function BlockBadge({
  ...
  return (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      ...
      <div className="smart-rag-chat-user-input-file-badge-name-suffix">

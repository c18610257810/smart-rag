...
import { ObsidianMarkdown } from '../chat-view/ObsidianMarkdown'
...
const ChatUserInput = forwardRef<ChatUserInputRef, ChatUserInputProps>(
  (
    ...
    return (
      <div className="smart-rag-chat-user-input-container" ref={containerRef}>
        <div className="smart-rag-chat-user-input-files">
          <ToolBadge />
          {mentionables.map((m) => (
            <MentionableBadge
        ...
        {/* Wrap contenteditable in non-flex container to avoid Chrome warning */}
        ...
        <div className="smart-rag-chat-user-input-controls">
            {/* FIX: Inline styles removed (partially), replaced with class. Wrapper style kept simple or moved to CSS recommended */}
            <div className="smart-rag-chat-user-input-controls__model-select-container">
            <ModelSelect />
            ...
            <select 
                ...
                className="smart-rag-query-mode-select"
          ...
          <div className="smart-rag-chat-user-input-controls__buttons">
...
function MentionableContentPreview({
  ...
  return displayFileContent ? (
    <div className="smart-rag-chat-user-input-file-content-preview">
